...
const ScenarioList = ({ type = 'active', showAddButton = false, onAddClick = null, enableDragDrop = false }) => {
    ...
    const loadScenarios = async () => {
        try {
            ...
            if (res.data.success) {
                let scenariosData = res.data.scenarios;
                
                // Filter based on type (simplified)
                if (type === 'active') {
                    scenariosData = scenariosData.filter(scenario => scenario.isRequired);
                }
    ...
    const filteredScenarios = scenarios.filter(scenario => {
        ...
        // Check if scenario has the specified level
